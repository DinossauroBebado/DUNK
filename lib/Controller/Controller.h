// ============================================================
// BIBLIOTECA Control CONTROLLER PARA ARDUINO/ESP32
// ============================================================
// Autor: Baseado em algoritmo Control equivalente ao MATLAB
// Versão: 1.0
// ============================================================
...
public:
    // Construtores
    ControlController();
    ControlController(const Matrix4x4 A_matrix, const Vector4 B_vector,
